            ...
            privacyFields.forEach(field => {
                ...
                if (Array.isArray(user[field])) {
                    user[field] = user[field].filter(item => {
                        ...
                        else if (item.privacy.value == 'includes' && item.privacy.includes.some(id => id == req.user._id)) return true;
                        else if (item.privacy.value == 'excludes' && !item.privacy.excludes.some(id => id == req.user._id) && isFriend) return true;
                        else return false;
                    });
                } else {
                    //check privacy of field
