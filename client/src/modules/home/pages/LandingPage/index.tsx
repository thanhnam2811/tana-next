			...
			<Layout.Container className={styles.container}>
				...
				<section className={styles.intro} id="intro">
					...
					<Typography.Text className={styles.description} data-aos="zoom-in-up">
						<strong>TaNa</strong> là một mạng xã hội mới, dành cho những người yêu thích sáng tạo và muốn
						chia sẻ kiến thức, kinh nghiệm và ý tưởng của mình với cộng đồng. Trên TaNa, người dùng có thể
						tạo và chia sẻ bài viết, hình ảnh, video, tham gia các nhóm chuyên đề, tạo dự án và sản phẩm
						sáng tạo. Mục tiêu của TaNa là tạo ra một cộng đồng sáng tạo, tích cực và mang lại giá trị cho
					...
					<div className={styles.content}>
						<Card className={styles.card} data-aos="flip-up" title="Mục tiêu">
							<Typography.Text>
								Được thành lập từ năm 2021, <strong>TaNa</strong> là một nền tảng kết nối và sáng tạo,
								nơi mọi người có thể tìm kiếm những người có cùng sở thích và sở trường để cùng nhau
								sáng tạo ra những sản phẩm độc đáo và đầy tính sáng tạo.
							</Typography.Text>
						</Card>

						<Card className={styles.card} data-aos="flip-up" title="Giá trị" data-aos-delay="400">
							<Typography.Text>
								<strong>TaNa</strong> luôn đặt lợi ích của người dùng lên hàng đầu, chúng tôi luôn cố
								gắng để mang đến những trải nghiệm tốt nhất cho người dùng.
							</Typography.Text>
						</Card>
